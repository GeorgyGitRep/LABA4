...
MyDate& MyDate::operator = (const MyDate dt) // �������� ������������ (�������� assign()) 
{
	day = dt.day;
	month = dt.month;
	year = dt.year;
...
MyDate::operator const char* () // �������� �������������� ���� �� MyDate � char*
{
	return "MyDate";
...
int operator ==(const MyDate& d1, const MyDate& d2) // �������� ��������� (�������� equal())
{
...
int operator <= (const MyDate& d1, const MyDate& d2) // �������� ��������� (�������� cmp())
{
...
MyDate& MyDate::operator +=(long d) // �������� ��������, ��������� ���������� ���� � ���� (�������� add_days())
{
	AddDays(d);

	return *this;
}
MyDate operator +(const MyDate& dt, long d) // �������� ��������, ��������� ���������� ���� � ����(�������� add_days())
{
	MyDate Dt;
	Dt = dt;
	Dt += d;
...
long operator -(const MyDate& d1, const MyDate& d2) // �������� ��������� (�������� cmp(), ���������� ������� � ���������� ���� ����� ������)
{
